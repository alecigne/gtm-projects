...
@Service("clientServiceImpManual")
public class ClientServiceImpManual implements ClientService {

	@Resource(name = "sqlDaoJpa")
	ManualClientDao clientDao;
	...
	public Client obtenirClient(long idClient) {
		return clientDao.obtenir(idClient);
	}
