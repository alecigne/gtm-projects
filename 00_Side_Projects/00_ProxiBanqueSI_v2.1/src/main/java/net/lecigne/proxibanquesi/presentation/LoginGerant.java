...
public class LoginGerant extends HttpServlet {

	private ConseillerService conseillerService = new ConseillerServiceImp();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Conseiller conseiller = conseillerService.obtenirConseiller(loginInput, passwordInput);
		...
		if (conseiller != null) {
			...
			response.sendRedirect(request.getContextPath() + "/login/autherror.jsp");
		}
	}
