...
@Configuration
@EnableJpaRepositories(basePackages={"ref.spring"})
@EnableTransactionManagement
@PropertySource("classpath:application.properties")
@ComponentScan(basePackages={"ref.spring"})
public class Config {
	@Autowired
	...
	private DatabasePopulator databasePopulator() {
		...
		databasePopulator.addScript(new ClassPathResource("initialisationDB.sql"));
...
/*	     <!-- JPA Persistence Context and EntityManager configuration -->
		...
		*/
		...
		entityManagerFactory.setPackagesToScan("ref.spring.model");
